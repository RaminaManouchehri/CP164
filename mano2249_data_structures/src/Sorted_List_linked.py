...
class Sorted_List:
    ...
    def insert(self, value):
        ...
        if self._front is None:
            ...
            while not inserted:
                ...
                if current._value <= value and current._next._value > value:
                    current._next = node
                    inserted = True
                else:
    ...
    def intersection(self, source1, source2):
        ...
        while i < source1._count:
            previous, current, index = source2._linear_search(current1._value)
            if index != -1:
    ...
    def split_key(self, key):
        ...
        while self._front is not None:
            ...
            self.remove(self._front._value)
    ...
    def combine(self, source1, source2):
        ...
        alt = source2._front
        while current is not None and alt is not None:
            if current._value < alt._value:
                val = current._next
                if len(self) == 0:
                    self._front = current
                    self._rear = current
